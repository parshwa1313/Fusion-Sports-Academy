  ...
  return (
    ...
    >
      ...
      <div className="absolute flex flex-col items-center w-full max-w-7xl px-4 gap-8 ">
        <h2 className="text-4xl font-bold mt-8 text-yellow-400">High Performance Program</h2>
        <div className="flex flex-col md:flex-row items-start w-full gap-12 mb-12">
          ...
          <div className="grid grid-cols-2 gap-6 mt-6">
            <img src="https://plus.unsplash.com/premium_photo-1661890079209-72b76e49768f?q=80&w=1610&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Tennis" className="rounded-lg shadow-lg h-56" />
            <img src="https://images.unsplash.com/photo-1630270395856-9c85ab98a75c?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className="rounded-lg shadow-lg h-56" />
            <img src="https://images.unsplash.com/photo-1525088068454-ff2c453e50e9?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Training" className="rounded-lg shadow-lg h-56" />
            <img src="https://images.unsplash.com/photo-1588795863192-962c7e866de0?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Sports" className="rounded-lg shadow-lg h-56" />
          </div>
        </div>
        ...
        <div className="text-center text-white ">
          ...
          <p className="text-xl text-yellow-400">(FOR ADVANCED)</p>
