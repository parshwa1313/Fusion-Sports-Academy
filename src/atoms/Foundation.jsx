      ...
      Foundation Development Program
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
          ...
          <div className="grid grid-cols-2 mt-8 gap-4 w-full max-w-2xl mx-auto">
            {[
              "https://as2.ftcdn.net/v2/jpg/01/57/41/25/1000_F_157412598_F0tYp2wFHLqYVwR40s4pSTX9EZwzPqNV.jpg",
              "https://cdn.pixabay.com/photo/2021/05/07/16/12/pandemic-6236577_1280.jpg",
              "https://as1.ftcdn.net/v2/jpg/03/19/66/72/1000_F_319667211_k0owduhaXLVHsSdync5FebwqYvicVBh5.jpg",
              "https://as1.ftcdn.net/v2/jpg/02/21/83/88/1000_F_221838806_REaUGEtnDiQcpqiMrCMqMtwIAB3xYwOq.jpg",
            ].map((src, index) => (
              <img
                key={index}
                src={src}
        ...
        <div className="text-center text-white mt-12">
          <h2 className="text-4xl font-bold mb-4 text-yellow-400">Program Details</h2>
